...
INSERT INTO `booking` VALUES (101,'2024-03-12','2024-03-15',101,101,2,1,'not check in'),(105,'2024-03-26','2024-03-28',103,105,4,2,'not check in'),(106,'2024-03-29','2024-03-30',101,106,3,2,'not check in'),(107,'2024-04-01','2024-04-03',102,103,2,1,'not check in'),(109,'2024-04-08','2024-04-09',101,102,4,3,'not check in'),(110,'2024-04-10','2024-04-16',102,103,3,1,'not check in'),(111,'2024-04-18','2024-04-20',103,105,3,1,'not check in'),(135,'2024-06-05','2024-06-06',101,171,3,1,'not check in'),(136,'2024-07-08','2024-07-12',102,172,1,1,'not check in');
...
INSERT INTO `feedback` VALUES (7,'ARIFUL ISLAM','arifhc65@gmail.com','Good'),(8,'HABIB ULLAH','arifhc65@gmail.com','well'),(9,NULL,NULL,NULL);
...
CREATE TABLE `payment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5027 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-07-07 18:16:52
